          ...
          <form action="" className="py-6 rounded shadow  bg-gray-50">
            ...
            <div className="px-3 mb-6">
              ...
              <textarea
                ...
                required
                className="block w-full px-4 py-10 leading-tight text-gray-700 bg-gray-100 rounded -gray-500    "
              ></textarea>
            </div>
            <div className="px-6">
              <button className="px-4 py-2 font-medium text-gray-100 bg-red-600 rounded shadow hover:bg-red-700 d-700">
                Send Message
              </button>
            </div>
          </form>
